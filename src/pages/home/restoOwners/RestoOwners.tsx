...
export const RestoOwners: React.FC = () => {
    ...
    const [currentProductToDecline, setCurrentProductToDecline] = React.useState<string>();
    ...
    return (
        <Container maxWidth="xl">
            <Dialog open={declineOpen} onClose={handleCloseDeclineModal} sx={{p: 5}}>
                ...
                <DialogActions>
                    <Button onClick={() => handleDecline(currentProductToDecline)}>Decline</Button>
                    <Button variant="contained" onClick={handleCloseDeclineModal}>Cancel</Button>
                </DialogActions>
            </Dialog>
